...
class TemperatureUtilsTest(unittest.TestCase):
    ...
    def test_temperature_tuple(self):
        ...
        expected = ((32, 0.0,273.15), (68, 20.0,293.15), (100, 37.78,310.93), (104, 40.0,313.15))
    ...
    def test2_temperature_tuple(self):
        ...
        expected = ((-17.7778, 0.0, 255.37), (0, 32.0,273.15), (100, 212.0,373.15))
    ...
    def test4_temperature_tuple(self):
        temps_input = (255.37, 273.15, 373.15)
        expected = ((255.37,-17.78, 0.0), (273.15,0, 32.0), (373.15, 100, 212.0))
